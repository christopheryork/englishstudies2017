...
\begin{figure*}
  \centering
	...
	\caption{Limiting the data graphed to the top or bottom ten lines (equivalent to sorting the CFRP crosstab table) allows users to clearly identify statistically-siginificant outliers in data.}
...
\begin{figure*}
  \centering
	...
	\caption{Nominal receipts per decade: the Comédie Française's most lucrative playwrights}
