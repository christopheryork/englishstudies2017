...
\lfoot{\footnotesize Exploratory data analysis for the digital humanities}
\cfoot{}
...
\title{Exploratory data analysis for the digital humanities: the Comédie Française Registers Project Analytics Tool}					% Title of your article goes here
...
\postauthor{\footnotesize \usefont{OT1}{phv}{m}{sl} \color{Black}
          Yale University \& MIT Hyperstudio
					\thanks{Thanks to Elyse Graham and Jeff Ravel for editorial advice, use cases and concluding suggestions.}
					\end{flushleft}
	\HorRule
	\newline
	\footnotesize
